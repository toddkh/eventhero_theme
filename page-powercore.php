<?php
/*
Template Name: PowerCore
*/
?>

<section id="home" class="hero_v3">
<img src="<?php the_field('powercore_hero_image', 'option'); ?>" class="hidden-sm hidden-xs"/>
...
<section id="testimonial" class="dark">
    <div class="wrap container" role="document">
                        <div class="content row">
                            <blockquote class="testimonial"><?php the_field('powercore_home_testimonial', 'option'); ?></blockquote>
